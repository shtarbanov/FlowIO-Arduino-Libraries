 ...
 * TODO: Make it possible to run this test without having to look at the serial monitor. This would require us to 
 * remove the while(!Serial) loop which prevents the rest of the code from funning until the serial monitor is started.
 */
